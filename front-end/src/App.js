...
import DoctorCurrentAppointments from "./components/DoctorCurrentAppointment";
...
import PatientAppointmenthHistory from "./components/PatientAppointmentHistory";
...
import AddDoctorTimeTable from "./components/AddDoctorTimeTable";

function App() {
  return (
  <div>
    <BrowserRouter>
    <Header title="DoctorAppoint" />
      <Routes>
        ...
        <Route path="/addTimeTableSlots" element={<AddDoctorTimeTable />}></Route>
