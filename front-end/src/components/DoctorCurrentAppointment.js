...
function DoctorCurrentAppointment(){
        ...
        <br/><br/>           
         <div>
                ...
                <table className="table table-bordered">
                    ...
                    {appointments.map((v) => {
                            return (
                                <tr key={v.appointmentId}>
                                    <td>{v.appointmentDate}</td>
                                    <td>{v.appointmentTime}</td>
                                    <td>{v.appointmentType}</td>
                                    <td>{v.status}</td>
                                    <td>{v.patient_id ? v.patient_id.patientId : 'N/A'}</td>
                                    <td>{v.patient_id ? `${v.patient_id.firstName} ${v.patient_id.lastName}` : 'N/A'}</td>
                                    <td>
...
export default DoctorCurrentAppointment;